...
;@Ahk2Exe-SetDescription Intune Win32 Launcher 1.8
		...
		If LogFile != A_Temp "\" FileName ".log"
			...
			If !FileExist(LogFile)
				...
				Loop parse, LogFile, "\"
					...
					If A_Index = 1
						{
						LogDrive := A_LoopField
						If !FileExist(LogDrive . "\")
							{
					...
					Else
						...
						If !InStr(A_LoopField, ".")
							{
							LogFolders := LogFolders . "\" . A_LoopField
							If !FileExist(LogDrive . LogFolders)
								DirCreate LogDrive . LogFolders
							}
						}
					}
				}
				...
				Else
					...
					If SubStr(Command, 1, 1) = "|"
						...
						Else
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ INFO  ]`tMsiInstallProduct stopped with return code: " ExitCode "`r`n" , LogFile
							}
						}
					Else
						{
						...
						Else
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ INFO  ]`tCommand with Process Id '" PID "' stopped with return code: " ExitCode "`r`n" , LogFile
							}
						}
...
Else
	...
	Else
		{
		; --------------------------------------------------------------- Create INI File ---------------------------------------------------------------
		SetupFilePath := FileSelect(3, A_ScriptDir, "Select a Windows Installer file", "(*.exe; *.msi; *.mst; *.appv; *.msix)")
		If SetupFilePath
			{
			ReservedCharacters := "<>:;`"/\|?*,|"
			...
			If TransformFileName
				{
				SetupFilePath := FileSelect(3, A_ScriptDir . "\" . WorkingDir, "Select the Windows Installer file for " TransformFileName, "(*.msi)")
				If SetupFilePath
			...
			If Extension = "exe"
				...
				FileAppend "IfEqual, ReturnCode, 0 OR 1707 OR 1641 OR 3010, Register_Install,, Register installation when the last return code is successfull.`r`n", IniFile
				FileAppend "`r`n", IniFile
				...
				IniWrite "Pending reboot detected. Please restart your system first to continue this installation.", IniFile, "NotifyPendingReboot", "InformationText"
				IniWrite "Continue", IniFile, "NotifyPendingReboot", "ContinueLinkText"
				...
				IniWrite "%ProductName% is about to be installed on this system. Save your work and close this application when it is active.", IniFile, "NotifyStartInstall", "InformationText"
				IniWrite "The installation will start in (mm:ss):", IniFile, "NotifyStartInstall", "TimerText"
				IniWrite "Defer", IniFile, "NotifyStartInstall", "DeferLinkText"
				IniWrite "Continue", IniFile, "NotifyStartInstall", "ContinueLinkText"
				...
				IniWrite "%ProductName% is being installed. Do not turn off your computer during the installation. Please wait...", IniFile, "NotifyProgressInstall", "InformationText"
				FileAppend "`r`n", IniFile
				...
				IniWrite "The installation of the software is successfully completed.", IniFile, "NotifyFinishInstall", "InformationText"
				IniWrite "Continue", IniFile, "NotifyFinishInstall", "ContinueLinkText"
				...
				FileAppend "IfEqual, ReturnCode, 0 OR 1707 OR 1641 OR 3010, Register_UnInstall,, Register removal when the last return code is successfull.`r`n", IniFile
				FileAppend "`r`n", IniFile
				...
				IniWrite "%ProductName% is about to be removed. Save your work and close this application when it is active.", IniFile, "NotifyStartUnInstall", "InformationText"
				IniWrite "The removal will start in (mm:ss):", IniFile, "NotifyStartUnInstall", "TimerText"
				IniWrite "Defer", IniFile, "NotifyStartUnInstall", "DeferLinkText"
				IniWrite "Continue", IniFile, "NotifyStartUnInstall", "ContinueLinkText"
				...
				IniWrite "%ProductName% is being removed from this system. Do not turn off your computer during the removal. Please wait...", IniFile, "NotifyProgressUnInstall", "InformationText"
				FileAppend "`r`n", IniFile
				...
				IniWrite "The removal of the software is successfully finished.", IniFile, "NotifyFinishUnInstall", "InformationText"
				IniWrite "Continue", IniFile, "NotifyFinishUnInstall", "ContinueLinkText"
			...
			If Extension = "msi"
				...
				IniWrite "%LogFolder%\%LogFileName%_Install.log", IniFile, "Install", "LogFile"
				IniWrite WorkingDir, IniFile, "Install", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%ProductCode%", IniFile, "Install", "SetSourceDir"
				...
				IniWrite "%LogFolder%\%LogFileName%_UnInstall.log", IniFile, "UnInstall", "LogFile"
				IniWrite WorkingDir, IniFile, "UnInstall", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%ProductCode%", IniFile, "UnInstall", "SetSourceDir"
			...
			If Extension = "appv"
				...
				IniWrite LogFileName, IniFile, "Variables", "LogFileName"
				IniWrite SetupFileName, IniFile, "Variables", "SetupFileName"
				IniWrite "%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe Set-ExecutionPolicy unrestricted -force;", IniFile, "Variables", "Powershell64"
				FileAppend "`r`n", IniFile
				IniWrite "Execution", IniFile, "Install", "SectionType"
				IniWrite "%LogFolder%\%LogFileName%_Install.log", IniFile, "Install", "LogFile"
				IniWrite WorkingDir, IniFile, "Install", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%PackageId%", IniFile, "Install", "SetSourceDir"
				IniWrite "0", IniFile, "Install", "DeleteSourceDir"
				IniWrite "", IniFile, "Install", "TaskKill"
				IniWrite "%Powershell64% Add-AppVClientPackage -path '%SetupFileName%' | Publish-AppVClientPackage -Global | Out-File '%LogFolder%\%LogFileName%_APPV_Add.log'", IniFile, "Install", "Command1"
				IniWrite "explorer.exe", IniFile, "Install", "CheckProcess"
				...
				FileAppend "Run, %Powershell64% Enable-Appv, %SystemRoot%,, 0`r`n", IniFile
				FileAppend "`r`n", IniFile
				FileAppend "[EnablePackageScripts]`r`n", IniFile
				FileAppend "Run, %Powershell64% Set-AppvClientConfiguration -EnablePackageScripts 1, %SystemRoot%,, 0`r`n", IniFile
				FileAppend "`r`n", IniFile
				FileAppend "[Check_Install]`r`n", IniFile
				FileAppend "IfEqual, ReturnCode, 0 OR 1707 OR 1641 OR 3010, Register_Install,, Register installation when the last return code is successfull.`r`n", IniFile
				FileAppend "`r`n", IniFile
				...
				IniWrite "%ProductVersion%", IniFile, "NotifyStartInstall", "ProductVersionText"
				IniWrite "%DisplayName% is about to be installed on this system. Save your work and close this application when it is active.", IniFile, "NotifyStartInstall", "InformationText"
				IniWrite "The installation will start in (mm:ss):", IniFile, "NotifyStartInstall", "TimerText"
				IniWrite "Defer", IniFile, "NotifyStartInstall", "DeferLinkText"
				IniWrite "Continue", IniFile, "NotifyStartInstall", "ContinueLinkText"
				IniWrite "3", IniFile, "NotifyStartInstall", "DeferTimes"
				...
				IniWrite "%ProductVersion%", IniFile, "NotifyProgressInstall", "ProductVersionText"
				IniWrite "%DisplayName% is being added to your system. Do not turn off your computer during the installation. Please wait...", IniFile, "NotifyProgressInstall", "InformationText"
				FileAppend "`r`n", IniFile
				IniWrite "Message", IniFile, "NotifyFinishInstall", "SectionType"
				IniWrite "0,1707", IniFile, "NotifyFinishInstall", "ReturnCodes"
				...
				IniWrite "%LogFolder%\%LogFileName%_UnInstall.log", IniFile, "UnInstall", "LogFile"
				IniWrite WorkingDir, IniFile, "UnInstall", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%PackageId%", IniFile, "UnInstall", "SetSourceDir"
				IniWrite "1", IniFile, "UnInstall", "DeleteSourceDir"				
				IniWrite "", IniFile, "UnInstall", "TaskKill"
				IniWrite "%Powershell64% Stop-AppVClientPackage -Name '%DisplayName%' -Global | Remove-AppVClientPackage | Out-File '%LogFolder%\%LogFileName%_APPV_Remove.log'", IniFile, "UnInstall", "Command1"
				IniWrite "explorer.exe", IniFile, "UnInstall", "CheckProcess"
				...
				IniWrite "%ProductVersion%", IniFile, "NotifyStartUnInstall", "ProductVersionText"
				IniWrite "%DisplayName% is about to be removed from your system. Save your work and close this application when it is active.", IniFile, "NotifyStartUnInstall", "InformationText"
				IniWrite "The removal will start in (mm:ss):", IniFile, "NotifyStartUnInstall", "TimerText"
				IniWrite "Defer", IniFile, "NotifyStartUnInstall", "DeferLinkText"
				IniWrite "Continue", IniFile, "NotifyStartUnInstall", "ContinueLinkText"
				IniWrite "3", IniFile, "NotifyStartUnInstall", "DeferTimes"
				...
				IniWrite "%ProductVersion%", IniFile, "NotifyProgressUnInstall", "ProductVersionText"
				IniWrite "%DisplayName% is being removed from this system. Do not turn off your computer during the removal. Please wait...", IniFile, "NotifyProgressUnInstall", "InformationText"
				FileAppend "`r`n", IniFile
				IniWrite "Message", IniFile, "NotifyFinishUnInstall", "SectionType"
				IniWrite "0,1707", IniFile, "NotifyFinishUnInstall", "ReturnCodes"
			...
			If Extension = "msix"
				...
				IniWrite "%LogFolder%\%LogFileName%_Install.log", IniFile, "Install", "LogFile"
				IniWrite WorkingDir, IniFile, "Install", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%PackageName%", IniFile, "Install", "SetSourceDir"
				IniWrite "0", IniFile, "Install", "DeleteSourceDir"
				IniWrite "", IniFile, "Install", "TaskKill"
				IniWrite "%Powershell64% Add-AppProvisionedPackage -online -packagepath '%SetupFileName%' -skiplicense | Out-File '%LogFolder%\%LogFileName%_MSIX_Add.log'", IniFile, "Install", "Command1"
				IniWrite "explorer.exe", IniFile, "Install", "CheckProcess"
				IniWrite "", IniFile, "Install", "NotifyPendingReboot"
				IniWrite "", IniFile, "Install", "NotifyStart"
				IniWrite "NotifyProgressInstall", IniFile, "Install", "NotifyProgress"
				...
				IniWrite "%LogFolder%\%LogFileName%_UnInstall.log", IniFile, "UnInstall", "LogFile"
				IniWrite WorkingDir, IniFile, "UnInstall", "WorkingDir"
				IniWrite "%windir%\SoftwareDistribution\Intune Win32 Launcher\%PackageName%", IniFile, "UnInstall", "SetSourceDir"
				IniWrite "1", IniFile, "UnInstall", "DeleteSourceDir"				
				IniWrite "", IniFile, "UnInstall", "TaskKill"
				IniWrite "%Powershell64% Remove-AppPackage -AllUsers -package '%PackageName%' | Out-File '%LogFolder%\%LogFileName%_MSIX_Remove.log'", IniFile, "UnInstall", "Command1"
				IniWrite "explorer.exe", IniFile, "UnInstall", "CheckProcess"
				IniWrite "", IniFile, "UnInstall", "NotifyStart"
				IniWrite "NotifyProgressUnInstall", IniFile, "UnInstall", "NotifyProgress"
				IniWrite "NotifyFinishUnInstall", IniFile, "UnInstall", "NotifyFinish"
				...
				IniWrite "", IniFile, "NotifyFinishUnInstall", "UserScript"
				IniWrite "5", IniFile, "NotifyFinishUnInstall", "Wait"
				MsgBox "The following INI file is created using the startup parameters `"Install`" and `"UnInstall`" for the selected MSIX File:`n`n" IniFile, ProductName " " ProductVersion, "64 T30"
				}
			}
		ExitApp 0
		}
...
; --------------------------------------------------------------- Function for creating a new (user) process using the token of an existing running process name. (if wait is 1 the process exit code will return else, the PID will return) ---------------------------------------------------------------
