...
;@Ahk2Exe-SetDescription MSIX Helper 1.5
...
If AppId
	...
	ShowGUI := IniRead(IniFile, AppId, "ShowGUI", "")
...
Script(Section)
	...
	Else
		{
		If FileExist(LogFile)
			FileAppend A_Now "`t[ ERROR ]`tConfiguration file not found: " IniFile "`n" , LogFile		
		}
	Return Counter
	}
