...
;@Ahk2Exe-SetDescription MSIX Helper 1.3
...
If AppId
	...
	If Target
		...
		If SetEnvSection
			{
			If FileExist(LogFile)
				FileAppend A_Now "`t[ INFO  ]`t[ Setting Session Environment Variables for section: " SetEnvSection " ]`n" , LogFile				
			...
			If A_LoopReadLine
				...
				If InStr(A_LoopReadLine, ",")
					...
					If (ScriptItemName = "IfEqual" or ScriptItemName = "IfNotEqual")
						...
						If ScriptItemName = "IfEqual"
							...
							If GotoElseSection
								{
								If FileExist(LogFile)
									FileAppend A_Now "`t[ INFO  ]`tUsing IfEqual statement for variable name '" CheckVariable "' with value '" CheckValue "'. When true goto script section '" GotoIfSection "'. Else goto script section '" GotoElseSection "'.`n" , LogFile
								}
							Else
								{
								If FileExist(LogFile)
					...
					If (ScriptItemName = "IfExist" or ScriptItemName = "IfNotExist")
						...
						If ScriptItemName = "IfExist"
							...
							If GotoElseSection
								{
								If FileExist(LogFile)
									FileAppend A_Now "`t[ INFO  ]`tUsing IfExist statement for file or folder (path) '" CheckFileFolder "'. When true, goto script section '" GotoIfSection "'. Else goto script section '" GotoElseSection "'.`r`n" , LogFile
								}
							Else
								{
								If FileExist(LogFile)
									FileAppend A_Now "`t[ INFO  ]`tUsing IfExist statement for file or folder (path) '" CheckFileFolder "'. When true, goto script section '" GotoIfSection "'. Else, continue...`r`n" , LogFile
								}
						...
						If ScriptItemName = "IfNotExist"
							...
							If GotoElseSection
								{
								If FileExist(LogFile)
									FileAppend A_Now "`t[ INFO  ]`tUsing IfNotExist statement for file or folder (path) '" CheckFileFolder "'. When true, goto script section '" GotoIfSection "'. Else goto script section '" GotoElseSection "'.`r`n" , LogFile
								}
							Else
								{
								If FileExist(LogFile)
									FileAppend A_Now "`t[ INFO  ]`tUsing IfNotExist statement for file or folder (path) '" CheckFileFolder "'. When true, goto script section '" GotoIfSection "'. Else, continue...`r`n" , LogFile
								}
					...
					If ScriptItemName = "EnvSet"
						...
						EnvSetValue := TransForm(EnvSetValue)							
						If FileExist(LogFile)
							FileAppend A_Now "`t[ INFO  ]`tEnvSet setting session environment variable name '" EnvSetName "' with value '" EnvSetValue "'`n" , LogFile
						Try
							EnvSet EnvSetName, EnvSetValue
						Catch as err
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ WARN  ]`tSession environment variable failed to set for '" EnvSetName "' with value '" EnvSetValue "' Error: " err.Message "`n" , LogFile							
							}
						Else
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ INFO  ]`tSession environment variable successfully set for '" EnvSetName "' with value: " EnvSetValue "`n" , LogFile
							}
						}
					If ScriptItemName = "RegRead"
						...
						Catch as err
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ WARN  ]`tSession environment variable failed to set for '" ValueName "' with value '" EnvSetValue "' Error: " err.Message "`n" , LogFile							
							}
						Else
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ INFO  ]`tSession environment variable successfully set for '" ValueName "' with value: " EnvSetValue "`n" , LogFile
							}
						}
					...
					If ScriptItemName = "IniRead"
						...
						Catch as err
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ WARN  ]`tSession environment variable failed to set for '" KeyName "' with value '" IniValue "' Error: " err.Message "`n" , LogFile							
							}
						Else
							{
							If FileExist(LogFile)
								FileAppend A_Now "`t[ INFO  ]`tSession environment variable successfully set for '" KeyName "' with value: " IniValue "`n" , LogFile
							}
						}
