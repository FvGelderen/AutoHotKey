		...
		if SelectedFolder
			...
			if SetupFilePath
				...
				if Extension = "exe"
					...
					if SubFolder
						IniWrite ".\" SubFolder "\" SetupFileName " /install /quiet /norestart /log `"%LogFolder%\%LogFileName%_EXE_Install.log`"", Inifile, "Install", "Command1"
					else
						IniWrite SetupFileName " /install /quiet /norestart /log `"%LogFolder%\%LogFileName%_EXE_Install.log`"", Inifile, "Install", "Command1"
					...
					if SubFolder
						IniWrite ".\" SubFolder "\" SetupFileName " /uninstall /quiet /norestart /log `"%LogFolder%\%LogFileName%_EXE_UnInstall.log`"", Inifile, "UnInstall", "Command1"
					else
						IniWrite SetupFileName " /uninstall /quiet /norestart /log `"%LogFolder%\%LogFileName%_EXE_UnInstall.log`"", Inifile, "UnInstall", "Command1"
